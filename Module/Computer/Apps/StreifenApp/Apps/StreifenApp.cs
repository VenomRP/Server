...
namespace GVRP.Module.Computer.Apps.StreifenApp.Apps
{
    ...
    public class StreifenApp : SimpleApp
    {
        ...
        [RemoteEvent]
        public void requestCurrentStreifen(Player client) 
        {
        ...
        [RemoteEvent]
        public void createStreife(Player client, string name, uint vehid)
        {
        ...
        [RemoteEvent]
        public void updateStreife(Player client, uint streifeId, string streifeName, uint streifeVehId, string streifeCode)
        {
        ...
        [RemoteEvent]
        public void askSupportStreife(Player client, uint streifeId)
        {
        ...
        [RemoteEvent]
        public void findStreife(Player client, uint streifeId)
        {
        ...
        [RemoteEvent]
        public void deleteStreife(Player client, uint streifeId)
        {
        ...
        [RemoteEvent]
        public void addOfficerToStreife(Player client, uint streifeId, string OfficerName)
        {
        ...
        [RemoteEvent]
        public void removeOfficerFromStreife(Player client, uint streifeId, string OfficerName)
        {
        ...
        [RemoteEvent]
        public void setStreifenState(Player client, int state)
        {
        ...
        [RemoteEvent]
        public void requestStreifenInfo(Player client) 
        {
