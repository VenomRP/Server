...
namespace GVRP.Module.Computer.Apps.SupportVehicleApp.Apps
{
    class SupportVehicleProfile : SimpleApp
    {
        ...
        [RemoteEvent]
        public async void requestVehicleData(Player client, int id)
        {
        ...
        [RemoteEvent]
        public async void SupportSetGarage(Player client, uint vehicleId)
        {
        ...
        [RemoteEvent]
        public async void SupportGoToVehicle(Player client, uint vehicleId)
        {
