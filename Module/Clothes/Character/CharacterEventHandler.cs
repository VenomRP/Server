...
namespace GVRP.Module.Clothes.Character
{
    public class CharacterEventHandler : Script
    {
        ...
        [RemoteEvent]
        public void SaveCharacter(Player client, int gender, byte fatherShape, byte motherShape, byte fatherSkin, byte motherSkin, float similarity, float skinSimilarity,
