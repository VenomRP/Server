...
namespace GVRP.Module.Items
{
    public class ItemsModuleEvents : Script
    {
        ...
        [RemoteEventPermission(AllowedOnCuff = false, AllowedOnTied = false, AllowedDeath = false)]
        [RemoteEvent]
        public async void fillInventorySlots(Player player, int inventoryType)
        {
        ...
        [RemoteEventPermission(AllowedOnCuff = false, AllowedOnTied = false, AllowedDeath = false)]
        [RemoteEvent]
        public async void moveItemInInventory(Player player, int sourceSlot, int destinationSlot, int inventoryType, int amount)
        {
        ...
        [RemoteEventPermission(AllowedOnCuff = false, AllowedOnTied = false, AllowedDeath = false)]
        [RemoteEvent]
        public async Task<bool> useInventoryItem(Player client, int slot)
        {
        ...
        [RemoteEvent]
        public void VehicleClawEvent(Player player, string returnString)
        {
