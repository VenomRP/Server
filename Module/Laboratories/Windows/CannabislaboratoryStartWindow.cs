...
namespace GVRP.Module.Laboratories.Windows
{
    public class CannabislaboratoryStartWindow : Window<Func<DbPlayer, Cannabislaboratory, bool>>
    {
        ...
        [RemoteEvent]
        public void saveCannabisLabor(Player client, float temperature, float pressure, float stirring, float amount)
        {
        ...
        [RemoteEvent]
        public void toggleCannabisLabor(Player client, bool result)
        {
            DbPlayer dbPlayer = client.GetPlayer();
