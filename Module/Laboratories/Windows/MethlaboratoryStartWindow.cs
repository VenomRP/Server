...
namespace GVRP.Module.Laboratories.Windows
{
    public class MethlaboratoryStartWindow : Window<Func<DbPlayer, Methlaboratory, bool>>
    {
        ...
        [RemoteEvent]
        public void saveMethLabor(Player client, float temperature, float pressure, float stirring, float amount)
        {
        ...
        [RemoteEvent]
        public void toggleMethLabor(Player client, bool result)
        {
            DbPlayer dbPlayer = client.GetPlayer();
