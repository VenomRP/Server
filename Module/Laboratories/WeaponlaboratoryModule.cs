...
namespace GVRP.Module.Laboratories
{
    public class WeaponlaboratoryModule : SqlModule<WeaponlaboratoryModule, Weaponlaboratory, uint>
    {
        ...
        {
            { 64, 40000 }, // Advanced / im not a fivem cheat developer but that would make sense, as you saw it iterated correctly the first weapon the repeated 1-1 attempts for sniper and shawnoffshotgun
           // { 995, 65000 }, // Sniperrifle / go ahead ill be back in 5 mins okk
       ...
       //     { 985, 35000 } // AK
        ...
        public override bool OnKeyPressed(DbPlayer dbPlayer, Key key)
        {
            ...
            } // that sjust an enum, the error says some class/object isnt initialized/is null 
