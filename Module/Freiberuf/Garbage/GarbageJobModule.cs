    ...
    public class GarbageJobModule : Module<GarbageJobModule>
    {
        ...
        public void loadTrashIntoVehicle(DbPlayer dbPlayer)
        {
            ...
            if(JobVehicle != null && JobVehicle.IsValid())
            {
                ...
                float newLoadage = (float)JobVehicle.entity.GetData<int>("loadage") + (float)dbPlayer.GetData("trash_amount");
                ...
                // Inform user
                dbPlayer.SendNewNotification($"Neuer Müllbestand im Fahrzeug: {JobVehicle.entity.GetData<int>("loadage")}");
            }
        }
        ...
        public void PickupTrash(DbPlayer dbPlayer, House house)
        {
            ...
            float currentVehicleLoadage = (float)jobVeh.entity.GetData<int>("loadage");
