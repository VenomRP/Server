...
namespace GVRP.Module.Players.Db
{
    ...
    public class DbPlayer
    {
        ...
        {
            return Team != null && Duty && (Team.IsCops() || Team.IsDpos() || Team.IsMedics() || Team.Id == (int)teams.TEAM_LSC || Team.Id == (int)teams.TEAM_DRIVINGSCHOOL || Team.Id == (int)teams.TEAM_NEWS);
        }
